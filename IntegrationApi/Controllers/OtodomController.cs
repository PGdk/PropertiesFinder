...

{
    ...
    { 
        private IOtodomRepository repository;
        private OtodomIntegration integration;

        public SprzedajemyController(IOtodomRepository repository, IDumpsRepository dump, IEqualityComparer<Entry> compare)
        {
            this.repository = repository;
            this.integration = new OtodomIntegration(dump, compare);
        }
