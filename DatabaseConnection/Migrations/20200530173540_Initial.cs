    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellerContacts", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OfferDetails_SellerContacts_SellerContactID",
                        column: x => x.SellerContactID,
                        principalTable: "SellerContacts",
                        principalColumn: "ID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Entries_PropertyAddresses_PropertyAddressID",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Entries_PropertyPrices_PropertyPriceID",
                        column: x => x.PropertyPriceID,
                        principalTable: "PropertyPrices",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                });
